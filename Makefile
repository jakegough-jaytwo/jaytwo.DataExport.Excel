...
BUILD_DIRS=./src/jaytwo.DataExport.Excel
BUILD_TEST_DIRS=./test/jaytwo.DataExport.Excel.Tests
...
docker-clean:
	docker compose --profile "*" down -v --remove-orphans || echo  "No compose project here (or nothing to clean). Skipping."
